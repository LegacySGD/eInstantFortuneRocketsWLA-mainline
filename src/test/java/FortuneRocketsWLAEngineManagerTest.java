...
public class FortuneRocketsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FortuneRocketsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FortuneRocketsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FortuneRocketsWLAIW/InitOutcome.xml").getDocumentElement();
